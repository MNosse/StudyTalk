package br.com.udesc.eso.tcc.studytalk.core.presentation.composable.signUp.view
...
import br.com.udesc.eso.tcc.studytalk.core.presentation.composable.signUp.viewmodel.SignUpEvent
import br.com.udesc.eso.tcc.studytalk.core.presentation.composable.signUp.viewmodel.SignUpViewModel
...
fun SignUpScreen(
    ...
    if (snackbarMessage.isNotBlank()) {
        LaunchedEffect(snackbarHostState) {
            ...
            viewModel.onEvent(SignUpEvent.ClearSnackbarMessage)
        }
    }
            ...
            Box(
                ...
                Column(
                    ...
                    Row(
                        ...
                        ClickableText(
                            text = AnnotatedString(text = "Acesse"),
                            style = TextStyle(
                                textDecoration = TextDecoration.Underline,
                                color = MaterialTheme.colorScheme.primary
                            ),
                            onClick = {
                                navController.navigate(InitialScreens.SignInScreen.route)
                            }
                        )
                    }
                }
