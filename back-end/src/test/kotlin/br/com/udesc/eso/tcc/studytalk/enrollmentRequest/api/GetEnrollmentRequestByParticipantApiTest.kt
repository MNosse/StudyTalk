...
class GetEnrollmentRequestByParticipantApiTest @Autowired constructor(
    ...
    fun setup(testInfo: TestInfo) {
        RestAssured.baseURI = "http://localhost:$port/studytalk/api/enrollment-requesties/participant"
