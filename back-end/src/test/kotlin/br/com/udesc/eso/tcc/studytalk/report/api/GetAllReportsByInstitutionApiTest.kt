...
class GetAllReportsByInstitutionApiTest @Autowired constructor(
    ...
    fun setup(testInfo: TestInfo) {
        RestAssured.baseURI = "http://localhost:$port/studytalk/api/reports/institution"
    ...
    fun withValidValues1() {
        val actualResponse = RestAssured.given()
            ...
            .extract()
            .jsonPath()
            .getList("reports", Report::class.java)
