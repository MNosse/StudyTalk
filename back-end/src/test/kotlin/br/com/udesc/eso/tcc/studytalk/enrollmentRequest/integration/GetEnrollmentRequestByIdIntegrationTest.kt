...
import br.com.udesc.eso.tcc.studytalk.infrastructure.enrollmentRequest.controller.GetEnrollmentRequestByIdController
...
class GetEnrollmentRequestByIdIntegrationTest @Autowired constructor(
    private val institutionRepository: InstitutionRepository,
    private val enrollmentRequestRepository: EnrollmentRequestRepository,
    private val participantRepository: ParticipantRepository,
    private val getEnrollmentRequestByIdController: GetEnrollmentRequestByIdController
) {
    ...
    fun withValidValues1() {
        assertDoesNotThrow {
            val response = getEnrollmentRequestByIdController.getEnrollmentRequestById(
                id = 1L,
    ...
    fun withoutPrivilege() {
        assertThrows<ParticipantWithoutPrivilegeException> {
            getEnrollmentRequestByIdController.getEnrollmentRequestById(
                id = 1L,
                requestingParticipantUid = participant1Uid
            )
        }
